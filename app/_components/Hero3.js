          ...
          <div className="grid grid-cols-1 gap-y-8 lg:grid-cols-2 lg:items-center lg:gap-x-16">
            <div className="mx-auto max-w-lg text-center lg:mx-0 ltr:lg:text-left rtl:lg:text-right">
              ...
              <p className="mt-4 text-gray-500">
                Let's see how you can use our platform. Using our easy to follow
                steps, you will be able to upload any file type in no time!
                Upload your documents in a few simple steps.
              </p>
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              {howList?.map((list) => (
                ...
                >
                  ...
                  <div>
                    <h2 className="mt-2 font-bold">{list.title}</h2>

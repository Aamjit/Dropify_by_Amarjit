  ...
  return (
    <div className="relative py-4 flex flex-col justify-center items-center text-center rounded-lg shadow-md bg-white m-4 w-[80%] sm:w-[60%]">
      <div className="m-2 mb-4">
        ...
        <p className="text-xs text-gray-400">Please find below details</p>
        <p className="text-xs text-gray-400">Click the icon to download</p>
      </div>
      ...
      <div className="flex flex-col justify-center items-center p-6 text-left sm:p-4">
        <div className="flex flex-row gap-2 flex-wrap justify-center">
          ...
          <p className="text-md font-bold text-primary">{file.FileName}</p>
        </div>
        <div className="flex flex-row gap-2">
          <p className="text-sm font-normal text-gray-500">⚡{file.FileType}</p>

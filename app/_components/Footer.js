...
function Footer() {
  ...
  const socialLink = [
    ...
    { id: 3, name: "Github", url: "https://github.com/Aamjit", icon: FaGithub },
    {
      id: 4,
      name: "LinkedIn",
    ...
    <footer className="bg-gray-900">
      <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <p className="mx-auto mt-6 max-w-md text-center leading-relaxed text-gray-500">
          Dropify is developed using NextJS, ReactJS as client components, Clerk
          to provide user authentication and account handling, Resend to send
          notification as emails, Firebase as cloud storage for our uploaded
          files.
        </p>
